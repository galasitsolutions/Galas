    ...
    <>
      ...
      <div className="flex flex-row items-center">
        <div className="m-auto justify-center items-center">
          <div className="p-4 ">
            <img src={Cityvibe} alt="Cityvibe" className="h-20 w-auto rounded-lg" />
          </div>
        </div>
        <div className="m-auto  flex justify-center items-center">
          <div className="p-4">
            <img src={BrandLogo} alt="BrandLogo" className="h-10 w-auto rounded-lg" />
          </div>
        </div>
        <div className="m-auto  flex justify-center items-center">
          <div className="p-4">
            <img src={Ankikerris} alt="Ankikerris" className="h-16 w-auto rounded-lg" />
          </div>
        </div>
      </div>
    </section>
