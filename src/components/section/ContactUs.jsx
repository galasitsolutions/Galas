...
export default function ContactUs() {
  ...
  const contactUsProps = {
    ...
    contactSubtitle: "Email, call, or complete the form to learn how Galas can solve your problem.",
    email: "info@galasitsolutions.com",
    phoneNumber: "+91 81787 77874",
    supportText: "Reach out to our support team for assistance with any issues or inquiries.",
    feedbackText: "We value your feedback to improve our services and meet your needs better.",
  ...
  return (
    <>
      ...
      <section className="contact-us relative w-full h-full bg-neutral-200 text-black">
        ...
        <section className="contact-inner container mx-auto px-10 flex flex-wrap gap-10 flex-col lg:flex-row justify-center items-stretch">
          <section className="card flex-1 flex flex-col">
            <article className="card-contact flex flex-col gap-6 justify-between grow items-start rounded-lg flex-wrap">
              <div className="inner-content flex flex-col grow gap-2">
                ...
                <a href={`tel:${contactUsProps.phoneNumber}`} className="number">
